...
public class DeckController extends AbstractController {
     ...
     */
    public void setCurrentDeck(List<Object> information) {
     ...
     */
    public String getCurrentDeckName(){ return this.currentDeck.getDeckName(); }
     ...
     */
    public void setModifiedDeck(Object information){
     ...
     */
    public void setCurrentDeckCards() {
     ...
     */
    public List<String> getDeckCategory(String deckName){
     ...
     */
    public Deck getCurrentDeckObjet(String currentDeckName){
        for (Deck deck : decks) {
     ...
     */
    public int getIndexDeck(Deck deck){
     ...
     */
    public void deleteCard(Object information){
     ...
     */
    public void exportDeck(List<Object> information) {
     ...
     */
    public void importDeck(List<Object> information) {
     ...
     */
    public boolean saveNewDeck(List<Object> information) {
     ...
     */
    public boolean saveNewCard(List<Object> information) {
     ...
     */
    public void updateToken(List<Object> information){
